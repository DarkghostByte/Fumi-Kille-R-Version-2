<template>
  ...
  <div>
    ...
    <div class="mr-6">
      <h1 class="py-6 px-2 text-4xl font-semibold mb-2">Comercio</h1>
    </div>
    ...
    <div class="flex">
      <el-form :model="form1" label-width="auto" style="max-width: 100%" ref="formRef" :rules="rules"
        ...
        <p class="px-5 datosCliente1">Datos del cliente:</p>
        <div class="flex">
        ...
        <p class="px-5 datosCliente1">Datos del negocio:</p>
        <div class="flex">
          <el-form-item style="width: 450px;" prop="tradename" label="Nombre Comercial:" class="px-5">
            <el-input v-model="form1.tradename" class="" placeholder="Ingresa el nombre del comercio" />
          </el-form-item>
          <el-form-item prop="comercio" label="Tipo de comercio:" class="px-5" style="width: 400px;">
        ...
        <!-- Sexta Fila -->
        <p class="px-5 datosCliente1">Contacto:</p>
        <div class="flex">
        ...
        <!-- Septima Fila -->
        <p class="px-5 datosCliente1">Contratacion:</p>
        <div class="flex">
        ...
        <p class="px-5 datosCliente1">Requiere de:</p>
        <div class="flex">
