  ...
  <div>
    <div class="container mx-auto px-4">
      ...
      <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-semibold">Consulta de Certificados</h1>
        <div class="py-3">
    ...
    <div class="flex mb-4" style="justify-content: center;">
      <div class="flex mb-4" style="width: 80%;">
        <el-input class="px-2" placeholder="Buscar por folio/ID" v-model="searchQueryId"
        @input="filterDataId" />
  ...
  methods: {
    ...
    filterDataId() {
      this.filteredData = this.tableData.filter(item => 
        item.id.toString().includes(this.searchQueryId)
      );
    },
