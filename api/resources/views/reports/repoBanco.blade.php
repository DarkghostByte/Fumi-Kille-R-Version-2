...
<head>
    <meta charset="UTF-8">
    <title>Reporte Saldo Banco</title>
</head>
<body>
    <div id="main-container">

    <h2 style="position: absolute; margin-top: -70px; margin-left:250px;">Reporte Saldo Banco</h2>
        ...
        <table id="table2">
            ...
            <!-- @ endforeach -->
                <tr id="fondoTotal2"> 
                        ...
                        <td style="width: 270px;" id="txt">Total</td>
