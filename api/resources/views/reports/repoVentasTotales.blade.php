...
<body>
    <div class="divImg">
        ...
        <h1 style="position: absolute; color: #1a5084; margin-top:30px;">Fumigaciones FUMI-KILLE'R</h1>
        <h1 style="position: absolute; color: #1a5084; margin-top:-10px; margin-left:52.5%; font-size:25px;">Período: 
